...
class ErnieTokenizer(object):
    ...
    def __init__(self,
        ...
        pat_str += r'([a-zA-Z0-9]+|\S)'####\S匹配所有非空格字符
    ...
    def tokenize(self, text):
        ...
        res = []
        # print(self.pat)
        for match in self.pat.finditer(text):##匹配结果的迭代器
    ...
    def encode(self, text, pair=None, truncate_to=None):
        ...
        return ret_id, ret_id_type###token id and 文本id
...
if __name__ == "__main__":
    ...
    text = "我是中国人"
    text1 = "我来自北京"
    res,res1 = tokenizer.encode(text,text1)
    print(res)
    print(res1)
